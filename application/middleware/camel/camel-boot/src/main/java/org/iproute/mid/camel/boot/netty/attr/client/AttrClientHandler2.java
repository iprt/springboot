 ...
 */
@Slf4j
public class AttrClientHandler2 extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        if (nettyChannel == null) {
            log.info("AttrClientHandler2 的 channelActive 中  Attribute 不存在值");
            ...
            log.info("AttrClientHandler2 的 channelActive 中  Attribute 存在值");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (nettyChannel == null) {
            log.info("AttrClientHandler2 的 channelRead 中  Attribute 不存在值");
            NettyChannel newNettyChannel = NettyChannel.builder().name("AttrClientHandler1").date(new Date()).build();
            attr.setIfAbsent(newNettyChannel);
        } else {
            log.info("AttrClientHandler2 的 channelRead 中  Attribute 存在值");
            log.info("Attribute nettyChannel = {}", nettyChannel);
        }
