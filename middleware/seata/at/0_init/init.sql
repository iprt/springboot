drop database if exists `seata-business`;
drop database if exists `seata-order`;
drop database if exists `seata-points`;
drop database if exists `seata-storage`;


create database `seata-business`;
create database `seata-order`;
create database `seata-points`;
